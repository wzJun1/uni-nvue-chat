	...
	<view class="uni-indexed-list" ref="list" id="list">
		...
		<list class="uni-indexed-list__scroll" scrollable="true" show-scrollbar="false" style="background-color: white;">
			...
			<uni-list-item @click="newFriend" :showArrow="false" title="新的朋友" thumb="../../static/images/new_f.png" thumbStyle="width:40px;height:40px;border-radius:5px"
			 textStyle="font-weight:400;color:black" :badgeText="showNewFriendBadgeCount" :showBadge="isShowNewFriendBadge"
			 badgeType="error" />
			<uni-list-item :showArrow="false" title="我的群聊" thumb="../../static/images/group.png" thumbStyle="width:40px;height:40px;border-radius:5px"
